# Copyright (c) 2023. See https://github.com/urchade/GLiNER for details.
...
if __name__ == "__main__":
    ...
    path_pile_ner = os.path.join(output_folder, 'train.json')
    data = load_data(path_pile_ner)
    processed_data = process_data(data)

    save_data_to_file(processed_data, os.path.join(output_folder, 'pilener_train.json'))
